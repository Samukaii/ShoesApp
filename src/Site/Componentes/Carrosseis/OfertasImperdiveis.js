...
class OfertasImperdiveis extends Component
{
    render()
    {
        return(
            <div className="my-5">
                <h4 className="font-weight-bold ml-3 mb-4">Ofertas Imperdíveis</h4>
                <CarrosselBody carrosselId="imperdiveis">
                    <CarrosselInner>
                        <CarrosselItemPerson ativo>
                            <CardGroup>
                                <CardBody imgTop = "./assets/ofertas imperdiveis/ofimp 1-1.png" c="mx-3">
                                ...
                                <CardBody imgTop = "./assets/ofertas imperdiveis/ofimp 1-2.png" c="mx-3">
                                ...
                                <CardBody imgTop = "./assets/ofertas imperdiveis/ofimp 1-3.png" c="mx-3">
                                ...
                                <CardBody imgTop = "./assets/ofertas imperdiveis/ofimp 1-4.png" c="mx-3">
                        ...
                        <CarrosselItemPerson>
                            <CardGroup>
                                <CardBody imgTop = "./assets/ofertas imperdiveis/ofimp 2-1.png" c="mx-3">
                                ...
                                <CardBody imgTop = "./assets/ofertas imperdiveis/ofimp 2-2.png" c="mx-3">
                                ...
                                <CardBody imgTop = "./assets/ofertas imperdiveis/ofimp 2-3.png" c="mx-3">
                                ...
                                <CardBody imgTop = "./assets/ofertas imperdiveis/ofimp 2-4.png" c="mx-3">
